<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alterar_senha.aspx.cs" Inherits="prjTCC.alterar_senha" %>
                ...
                <div class="info-conta-container-flex">
                    <div class="itens-menu-conta">
                        ...
                        <ul>
                            ...
                            <li class="pagina-ativa"><a href="alterar_senha.aspx"><i class="fa-solid fa-key"></i> Alterar senha</a></li>
                    ...
                    <div class="menu-conta">
                        <div>
                            <div class="form-dados-cadastrais">
                                ...
                                <label for="txtSenhaAntiga">Senha atual:</label>
                                <asp:TextBox ID="txtSenhaAntiga" CssClass="inputs" runat="server" type="password"></asp:TextBox>

                                <label for="txtNovaSenha">Senha nova:</label>
                                <asp:TextBox ID="txtNovaSenha" CssClass="inputs" runat="server" type="password"></asp:TextBox>

                                <label for="txtConfirmacao">Confirme a senha nova:</label>
                                <asp:TextBox ID="txtConfirmacao" CssClass="inputs" runat="server" type="Password"></asp:TextBox>

                                <asp:Button ID="btnAlterarSenha" CssClass="fr botoes" runat="server" Text="Alterar senha" OnClick="btnAlterarSenha_Click" />
