...
namespace prjTCC
{
    public partial class dona_agenda : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ListaNomeECodigoFuncionario listaNomeECodigoFuncionario = new ListaNomeECodigoFuncionario();
                    List<KeyValuePair<int, string>> dados = listaNomeECodigoFuncionario.listarNomeECodigoFuncionarioValuePair();
                    drpFuncionario.DataSource = dados;
                    drpFuncionario.DataValueField = "Key";//"cd_funcionario";
                    drpFuncionario.DataTextField = "Value";//"nm_funcionario";
        ...
        public void MostrarAgenda ()
        {
            try
            {
                ...
                List<Agendamento> agendamentos = listaAgendamentoPorSemana.ListarAgendamentosPorSemana(diaSelecionado.Date.ToString("yyyy-MM-dd"), (drpFuncionario.SelectedValue).ToString());
